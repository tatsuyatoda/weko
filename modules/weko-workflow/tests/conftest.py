...
def db_register(app, db, db_records, users, action_data, item_type):
    ...
    activity_no_contents = Activity(activity_id='A-00000001-10005',workflow_id=1, flow_id=flow_define.id,
                    ...
                    activity_community_id=3,
                    activity_confirm_term_of_use=True,
                    title='test', shared_user_ids=[], extra_info={"record_id": 1, "file_name":"recid/1.0"},
                    action_order=6)
    with db.session.begin_nested():
    ...
    return {'flow_define':flow_define,
            ...
            "activities":[activity,activity_item1,activity_item2,activity_item3,activity_item7,activity_item8,activity_item9,activity_item10,activity_guest,activity_landing_url,activity_terms_of_use,activity_no_contents]}
